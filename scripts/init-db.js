...
const boards = [
  ...
  },
  {
    code: 'v',
    name: 'Video Games',
    description: 'Tendies, console wars, COD classics, all things GTA, anything hot right now',
    isNSFW: false,
  ...
  },
  {
    code: 'a',
    name: 'Anime & Manga',
    description: 'Waifu wars, seasonal autism, /a/ sings, One piece threads never end, Classics talk',
    isNSFW: true,
    maxFileSize: 8 * 1024 * 1024,
    allowedFileTypes: ['image/jpeg', 'image/png', 'image/gif', 'image/webp']
  },
  {
    ...
    description: 'Shitcoins, launchpad wars, KOL rug accusations, Hyperliquid whales, perpetual cope, wen breakout',
    isNSFW: true,
    maxFileSize: 8 * 1024 * 1024,
    allowedFileTypes: ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'video/webm']
  },
